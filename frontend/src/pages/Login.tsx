        ...
        <div className="max-w-lg mx-auto">
          <div className="text-center mb-10">
            <div className="inline-flex items-center space-x-2 bg-gradient-primary/10 backdrop-blur-sm rounded-full px-6 py-2 mb-6">
              ...
              <span className="text-sm font-medium text-primary">Premium Access Portal</span>
            </div>
            <h1 className="text-4xl font-bold premium-gradient mb-4">Welcome Back</h1>
            <p className="text-muted-foreground text-lg">Sign in to continue your luxury property journey</p>
          </div>

          <div className="luxury-card p-8 shadow-luxury">
